...
namespace DropParty
{
    public class GameLoop
    {
        ...
        public void Restart(List<Type> playerTypeList)
        {
            // remove all Examplebots
            // for(int i=playerTypeList.Count-1; i>=0; i--)
            // {
            //     if (playerTypeList[i] == typeof(ExampleBot))
            //     {
            //         playerTypeList.RemoveAt(i);
            //     }
            // }

            // add four new ExampleBots
            // playerTypeList.Add(typeof(ExampleBot));
            // playerTypeList.Add(typeof(ExampleBot));
            // playerTypeList.Add(typeof(ExampleBot));
            // playerTypeList.Add(typeof(ExampleBot));
        ...
        public bool Step(bool isRenderingEnabled)
        {
            if (!myWindow.IsOpen) return false;
